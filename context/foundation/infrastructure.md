...
| Pages-vs-Workers ambiguity → agent fetches wrong-product docs, config drifts | Devil's advocate | M | M | Commit to **Workers Static Assets** in `tech-stack.md` + this file; pin `wrangler.toml` `[assets]`; agent reads only Workers docs |
