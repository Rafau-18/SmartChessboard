...
- 2026-07-01: `research.md` seeded ahead of the change folder (commit `2ad21bc`) by a multi-agent research workflow — root-cause hypotheses for the S-09 BLE instability, diagnostic plan, and fix candidates. Findings were hypotheses pending verification.
