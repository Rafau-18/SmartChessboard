...
- [ ] 1.1 Reducer/contract compiles (`:shared:compileKotlinAndroid`)
- [ ] 1.2 Reducer unit tests pass (`:shared:testAndroidHostTest`, extends `PhysicalPlayReducerTest.kt`)
- [ ] 1.3 iOS + wasm targets green (`:shared:iosSimulatorArm64Test`, `:shared:wasmJsTest`)
- [ ] 1.4 ktlint clean (`ktlint -F`)
