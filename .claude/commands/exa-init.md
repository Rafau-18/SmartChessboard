...
| Coding Tool | Claude |
| Integration | MCP |
| Use Case | Chess Kotlin Multiplatform application with chess rules engine. |

**Project Description:** Chess Kotlin Multiplatform application with chess rules engine.
